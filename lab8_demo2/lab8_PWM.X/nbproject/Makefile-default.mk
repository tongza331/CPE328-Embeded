...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/lab8_PWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=PWM_code.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/PWM_code.o
POSSIBLE_DEPFILES=${OBJECTDIR}/PWM_code.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/PWM_code.o

# Source Files
SOURCEFILES=PWM_code.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/lab8_PWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=ATmega328P
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/PWM_code.o: PWM_code.c  .generated_files/1e5e8d906cf5d09dc3e7c8242ff5011e2b20df75.flag .generated_files/7e9a0e7181271ca1092b3e7d1007afd0e838895a.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/PWM_code.o.d 
	@${RM} ${OBJECTDIR}/PWM_code.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1 -g -DDEBUG  -gdwarf-2  -x c -D__$(MP_PROCESSOR_OPTION)__   -mdfp="${DFP_DIR}/xc8"  -Wl,--gc-sections -O1 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -funsigned-char -funsigned-bitfields -Wall -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD)  -gdwarf-3     -MD -MP -MF "${OBJECTDIR}/PWM_code.o.d" -MT "${OBJECTDIR}/PWM_code.o.d" -MT ${OBJECTDIR}/PWM_code.o -o ${OBJECTDIR}/PWM_code.o PWM_code.c 
	
else
${OBJECTDIR}/PWM_code.o: PWM_code.c  .generated_files/444214c82cf513fcf82c91c017317376d654dc35.flag .generated_files/7e9a0e7181271ca1092b3e7d1007afd0e838895a.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/PWM_code.o.d 
	@${RM} ${OBJECTDIR}/PWM_code.o 
...
dist/${CND_CONF}/${IMAGE_TYPE}/lab8_PWM.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "dist/${CND_CONF}/${IMAGE_TYPE}/lab8_PWM.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "dist/${CND_CONF}/${IMAGE_TYPE}/lab8_PWM.X.${IMAGE_TYPE}.hex"
endif
